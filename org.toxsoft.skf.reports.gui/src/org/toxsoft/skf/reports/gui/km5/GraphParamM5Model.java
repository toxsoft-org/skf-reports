 ...
 * @author dima
 */
public class GraphParamM5Model
  ...
  private static class GraphParamPaneComponentModown
    ...
    public void onTsSelectionChanged( Object aSource, IVtGraphParam aSelectedItem ) {
      ...
      if( aSelectedItem != null ) {
        toolbar().getAction( ReportParamM5Model.ACTID_COPY_PARAM ).setEnabled( true );
      }
      else {
        toolbar().getAction( ReportParamM5Model.ACTID_COPY_PARAM ).setEnabled( false );
      }
    }
    ...
    protected ITsToolbar doCreateToolbar( ITsGuiContext aContext, String aName, EIconSize aIconSize,
      ...
      aActs.add( ReportParamM5Model.ACDEF_COPY_PARAM );
      aActs.add( ACDEF_SEPARATOR );
      aActs.add( ReportParamM5Model.ACDEF_SELECT_MULTY_PARAMS );
    ...
    protected void doProcessAction( String aActionId ) {
      ...
      switch( aActionId ) {
        case ReportParamM5Model.ACTID_COPY_PARAM:
          copyParam( selParam );
          break;
        case ReportParamM5Model.ACTID_SELECT_MULTY_PARAMS:
