...
interface ISkResources {
  ...
  String STR_N_REPORT_TEMPLATE  = Messages.getString( "STR_N_REPORT_TEMPLATE" );  //$NON-NLS-1$
  String STR_D_REPORT_TEMPLATE  = Messages.getString( "STR_D_REPORT_TEMPLATE" );  //$NON-NLS-1$
  String STR_N_FDEF_HAS_SUMMARY = Messages.getString( "STR_N_FDEF_HAS_SUMMARY" ); //$NON-NLS-1$
  String STR_D_FDEF_HAS_SUMMARY = Messages.getString( "STR_D_FDEF_HAS_SUMMARY" ); //$NON-NLS-1$
