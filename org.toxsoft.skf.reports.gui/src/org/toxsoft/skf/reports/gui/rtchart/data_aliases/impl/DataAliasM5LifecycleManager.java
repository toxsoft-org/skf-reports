 ...
 * @author dima
 */
class DataAliasM5LifecycleManager
    extends M5LifecycleManager<IDataNameAlias, ISkConnection> {

  public DataAliasM5LifecycleManager( IM5Model<IDataNameAlias> aModel, ISkConnection aMaster ) {
  ...
  private static IDataNameAlias bunch2DataAlias( IM5Bunch<IDataNameAlias> aValues ) {
    Gwid gwid = aValues.getAsAv( DataAliasM5Model.FID_GWID ).asValobj();
    String title = aValues.getAsAv( DataAliasM5Model.FID_TITLE ).asString();
    String descr = aValues.getAsAv( DataAliasM5Model.FID_DESCR ).asString();
