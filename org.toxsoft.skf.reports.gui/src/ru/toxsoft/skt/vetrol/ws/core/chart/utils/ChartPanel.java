package ru.toxsoft.skt.vetrol.ws.core.chart.utils;
...
public class ChartPanel
   ...
   */
  public void setReportAnswer( IList<IG2DataSet> aAnswer, IVtGraphTemplate aTemplate, boolean aFromBegin ) {
  ...
  private void fillChartData( IList<IG2DataSet> aAnswer, IVtGraphTemplate aTemplate ) {
  ...
  private void createChart( IList<IG2DataSet> aAnswer, IVtGraphTemplate aTemplate, boolean aFromBegin ) {
  ...
  private static ETimeUnit getAxisTimeUnit( IVtGraphTemplate aTemplate ) {
  ...
  void createPlots( IVtGraphTemplate aTemplate ) {
    int idx = 0;
    for( GraphicInfo graphInfo : graphicInfoes ) {
