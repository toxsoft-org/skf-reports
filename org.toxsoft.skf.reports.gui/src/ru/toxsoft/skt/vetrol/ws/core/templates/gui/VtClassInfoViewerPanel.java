 ...
 * @author dima
 */
public class VtClassInfoViewerPanel
    extends TsPanel {
  ...
  private VtObjectViewerPanel              skObjectPanel            = null;
  private RtDataInfoViewerPanel            rtDataPanel              = null;
  private ISkClassInfo                     selectedClass            = null;
  private VtObjectCheckedListPanel         skObjectCheckedListPanel = null;
  ...
  /**
   * @param aSkObjectPanel {@link VtObjectViewerPanel} panel to show objects of selected class
   */
  public void setSkObjectPanel( VtObjectViewerPanel aSkObjectPanel ) {
   ...
   */
  public VtClassInfoViewerPanel( Composite aParent, ITsGuiContext aContext ) {
  ...
  /**
   * @param aSkObjectCheckedListPanel {@link VtObjectCheckedListPanel} panel to show checkable list objects of selected
   *          class
   */
  public void setSkObjectListPanel( VtObjectCheckedListPanel aSkObjectCheckedListPanel ) {
