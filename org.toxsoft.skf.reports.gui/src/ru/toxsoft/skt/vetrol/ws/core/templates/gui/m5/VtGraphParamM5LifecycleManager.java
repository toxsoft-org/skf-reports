 ...
 * @author dima
 */
class VtGraphParamM5LifecycleManager
    extends M5LifecycleManager<IVtGraphParam, ISkConnection> {

  public VtGraphParamM5LifecycleManager( IM5Model<IVtGraphParam> aModel, ISkConnection aMaster ) {
  ...
  private static IVtGraphParam bunch2SkGraphParam( IM5Bunch<IVtGraphParam> aValues ) {
    Gwid gwid = aValues.getAsAv( VtGraphParamM5Model.FID_GWID ).asValobj();
    String title = aValues.getAsAv( VtGraphParamM5Model.FID_TITLE ).asString();
    String descr = aValues.getAsAv( VtGraphParamM5Model.FID_DESCR ).asString();
    String unitId = aValues.getAsAv( VtGraphParamM5Model.FID_UNIT_ID ).asString();
    String unitName = aValues.getAsAv( VtGraphParamM5Model.FID_UNIT_NAME ).asString();
    EAggregationFunc func = aValues.getAsAv( VtGraphParamM5Model.FID_AGGR_FUNC ).asValobj();
    EDisplayFormat format = aValues.getAsAv( VtGraphParamM5Model.FID_DISPL_FORMAT ).asValobj();
    ETsColor color = aValues.getAsAv( VtGraphParamM5Model.FID_COLOR ).asValobj();
    int lineWidth = aValues.getAsAv( VtGraphParamM5Model.FID_LINE_WIDTH ).asInt();
    boolean isLadder = aValues.getAsAv( VtGraphParamM5Model.FID_IS_LADDER ).asBool();
    IList<String> setPoints = aValues.getAs( VtGraphParamM5Model.FID_SET_POINTS, IList.class );
