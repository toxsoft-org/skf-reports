...
/**
 * Lifecycle manager for {@link VtGraphTemplateM5Model}.
 *
 * @author dima
 */
public class VtGraphTemplateM5LifecycleManager
   ...
   */
  public VtGraphTemplateM5LifecycleManager( IM5Model<IVtGraphTemplate> aModel, ISkConnection aMaster ) {
