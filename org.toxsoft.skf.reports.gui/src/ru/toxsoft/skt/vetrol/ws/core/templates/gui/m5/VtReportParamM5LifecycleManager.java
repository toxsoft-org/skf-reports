 ...
 * @author dima
 */
class VtReportParamM5LifecycleManager
    extends M5LifecycleManager<IVtReportParam, ISkConnection> {

  public VtReportParamM5LifecycleManager( IM5Model<IVtReportParam> aModel, ISkConnection aMaster ) {
  ...
  protected IVtReportParam doCreate( IM5Bunch<IVtReportParam> aValues ) {
    Gwid gwid = aValues.getAsAv( VtReportParamM5Model.FID_GWID ).asValobj();
    String title = aValues.getAsAv( VtReportParamM5Model.FID_TITLE ).asString();
    String descr = aValues.getAsAv( VtReportParamM5Model.FID_DESCR ).asString();
    EAggregationFunc func = aValues.getAsAv( VtReportParamM5Model.FID_AGGR_FUNC ).asValobj();
    EDisplayFormat format = aValues.getAsAv( VtReportParamM5Model.FID_DISPL_FORMAT ).asValobj();
