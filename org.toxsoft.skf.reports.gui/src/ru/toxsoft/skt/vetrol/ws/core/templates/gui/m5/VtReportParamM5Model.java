 ...
 * @author dima
 */
public class VtReportParamM5Model
  ...
  protected IM5LifecycleManager<IVtReportParam> doCreateDefaultLifecycleManager() {
    ...
    return new VtReportParamM5LifecycleManager( this, conn );
  }

  @Override
  protected IM5LifecycleManager<IVtReportParam> doCreateLifecycleManager( Object aMaster ) {
    return new VtReportParamM5LifecycleManager( this, ISkConnection.class.cast( aMaster ) );
  }
