...
import static ru.toxsoft.skt.vetrol.ws.reports.e4.uiparts.IVtResources.*;
 ...
 * @author dima
 */
public class VtGraphTemplateEditorPanel
    extends TsPanel {
   ...
   */
  public VtGraphTemplateEditorPanel( Composite aParent, ITsGuiContext aContext ) {
    ...
    IM5LifecycleManager<IVtGraphTemplate> lm = new VtGraphTemplateM5LifecycleManager( model, conn );
    ...
    MultiPaneComponentModown<IVtGraphTemplate> componentModown =
        new MultiPaneComponentModown<>( ctx, model, lm.itemsProvider(), lm ) {
          ...
          protected void doProcessAction( String aActionId ) {
            ...
            switch( aActionId ) {
              case VtReportTemplateEditorPanel.ACTID_COPY_TEMPLATE:
    ...
    componentModown.treeModeManager().addTreeMode( new TreeModeInfo<>( TMID_GROUP_BY_USER, IVtResources.STR_N_BY_USERS,
        IVtResources.STR_D_BY_USERS, null, treeMaker ) );
