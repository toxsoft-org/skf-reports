 ...
 * @author dima
 */
public class VtReportTemplateEditorPanel
    extends TsPanel {
   ...
   */
  public VtReportTemplateEditorPanel( Composite aParent, ITsGuiContext aContext ) {
    ...
    IM5LifecycleManager<IVtReportTemplate> lm = new VtReportTemplateM5LifecycleManager( model, conn );
    ...
    componentModown.treeModeManager().addTreeMode( new TreeModeInfo<>( TMIID_GROUP_BY_USER, IVtResources.STR_N_BY_USERS,
